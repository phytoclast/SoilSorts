...
ES111B.list <- list(
  ...
  F111BY502IN = c('Odell','Metamora', 'Markton', 'Macomb', 'Locke', 'Haskins', 'Elliott', 'Crosier', 'Conover', 'Capac', 'Blount', 'Aubbeenaubbee', 'Bennington', 'Crosby'),
  F111BY503IN = c('Cardington', 'Wawaka', 'Wapahani', 'St. Clair', 'Muncie', 'Williamstown', 'Wawasee', 'Strawn',  'Russell', 'Riddles', 'Rawson', 'Parr', 'Owosso', 'Mortimer', 'Morley', 'Mississinewa', 'Miami', 'Metea', 'Marlette', 'Lybrand', 'Kidder', 'Kendallville',  'Hillsdale', 'Hennepin', 'Glynwood', 'Cadmus', 'Amanda', 'Miamian'),
...
ES114A.list <- list(
  ...
  F114AY203IN = c("Banlic", "Atkins","Belknap", "Birds","Bonnie", "Evansville", "Holton", "Petrolia", "Shoals", "Sloan", "Stendal", "Taggart", "Wakeland", "Whitaker", "Wilhite", 'Riverwash'),
...
ES114B.list <- list(
  ...
  F114BY302IN = c('Wrays', 'Grayford', 'Ryker', 'Stinesville', 'Wellston','Blocher', 'Caneyville', 'Carmel', 'Coolville', 'Corydon', 'Crider', 'Deputy', 'Eden', 'Edenton', 'Gosport', 'Haggatt', 'Jennings', 'Jessietown', 'Kell', 'Kurtz', 'Milton', 'Nicholson', 'Rarden', 'Rohan', 'Scottsburg', 'Stonehead', 'Switzerland', 'Trappist', 'Weddel', 'Whitcomb', 'Zenas', 'Schuline'),
  ...
  F114BY804IN = c('Spickert', 'Deam', 'Alford', 'Homen', 'Hosmer', 'Menfro', 'Muren', 'Rumen', 'Winfield', 'Bedford', 'Medora', 'Muscatatuck', 'Nabb', 'Rossmoyne', 'Rozetta', 'Ruma', 'Shircliff', 'Weisburg'),
